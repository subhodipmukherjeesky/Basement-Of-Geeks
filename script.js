...
wireClicks('#peopleGrid .topic-card');
wireClicks('#eventsGrid .event-card');

// Make CTA button reflect the slide link as well
heroCta.addEventListener('click', () => {
  alert('CTA: ' + heroCta.textContent);
});
...
const data = [
  { desc: "Welcome to the frosted glass experience. Let’s start!", bg: "https://picsum.photos/id/1015/800/600" },
  { desc: "Step 2 brings you closer to the magic ✨", bg: "https://picsum.photos/id/1016/800/600" },
  { desc: "Enjoy the smooth animations and aesthetic vibes.", bg: "https://picsum.photos/id/1018/800/600" },
  { desc: "Glassmorphism meets progress tracking.", bg: "https://picsum.photos/id/1020/800/600" },
  { desc: "All done! 🎉 Thanks for trying this card.", bg: "https://picsum.photos/id/1024/800/600" }
];
